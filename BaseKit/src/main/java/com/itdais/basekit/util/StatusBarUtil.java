...
public class StatusBarUtil {
     ...
     * @param needOffsetView 需要向下偏移的 View
     */
    public static void setTranslucentForImageViewPadding(Activity activity, View needOffsetView) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
        setTransparentForWindow(activity);
    ...
    /**
     * 头部置顶 置顶控件需要增加statusbar的高度,防止
     *
     * @param activity       需要设置的activity
     * @param needOffsetView 需要向下偏移的 View
     */
    public static void setTranslucentForPadding(Activity activity, View needOffsetView) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
        setTransparentForWindow(activity);
        if (needOffsetView != null) {
            ...
            layoutParams.height = layoutParams.height + statusBar;
            needOffsetView.setPadding(0, statusBar, 0, 0);
        }
    }

    /**
     * 为头部是 Toolbar 增加statusbar的高度,防止toolbar置顶和高度被压缩
     *
     * @param activity       需要设置的activity
     * @param needOffsetView 需要向下偏移的 View
     */
    public static void setTranslucentForToolbar(Activity activity, View needOffsetView) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
        setTransparentForWindow(activity);
     ...
     * @param needOffsetView 需要向下偏移的 View
     */
    public static void setTranslucentForPadding(Activity activity, @IntRange(from = 0, to = 255) int statusBarAlpha, View needOffsetView, int viewHeight) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
        setTransparentForWindow(activity);
        ...
        if (needOffsetView != null) {
            ViewGroup.MarginLayoutParams layoutParams = (ViewGroup.MarginLayoutParams) needOffsetView.getLayoutParams();
            int statusBar = getStatusBarHeight(activity);
            layoutParams.height = viewHeight + statusBar;
            needOffsetView.setPadding(0, statusBar, 0, 0);
        }
    }
     ...
     * @param needOffsetView 需要向下偏移的 View
     */
    public static void setTranslucentForToolbar(Activity activity, @IntRange(from = 0, to = 255) int statusBarAlpha, View needOffsetView) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
        setTransparentForWindow(activity);
     ...
     * @param activity fragment 对应的 activity
     */
    public static void setTranslucentFragment(Activity activity, View needOffsetView) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
        setTransparentForWindow(activity);
